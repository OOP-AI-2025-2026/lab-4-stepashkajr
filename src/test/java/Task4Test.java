...
public class Task4Test {
    ...
    class Test {
        ...
        void test1() {
            ua.opnu.java.inheritance.bill.DiscountBill2 bill = new ua.opnu.java.inheritance.bill.DiscountBill2(new Employee("clerk-1"), true);
        ...
        void test2() {
            ua.opnu.java.inheritance.bill.DiscountBill2 bill = new ua.opnu.java.inheritance.bill.DiscountBill2(new Employee("clerk-2"), false);
        ...
        void test3() {
            ...
            ua.opnu.java.inheritance.bill.DiscountBill2 bill = new ua.opnu.java.inheritance.bill.DiscountBill2(new Employee("clerk-1"), preferred);
